...
// Função para formatar a renda bruta conforme o usuário digita
document.getElementById('rendaBruta').addEventListener('input', function(event) {
    let value = event.target.value.replace("R$ ", "").replace(/\D/g, '');
